...
#all in one:
/home/fschmuckermaier/IceCube2/build/env-shell.sh python /home/fschmuckermaier/POCAM_scripts/scripts/all_in_one_POCAM.py --output-i3-file="${path}/test_all_in_one.i3"
